...
{
	[Activity(Label = "TicketToTalk.Droid", Icon = "@drawable/app_icon", Theme = "@style/MyTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
